# Step 1: Load all homework files from the 'data' folder
import os
...
if uploaded_files:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Step 7: Generate embeddings using SentenceTransformer
        ...
        # Step 10: Flag and show highly similar pairs
        st.subheader("⚠️ Detected Potential Plagiarism:")
        flagged = False
